...
namespace CinemaManager.DB
{
    ...
    {
        public static List<CinemaHall> CinemaHalls = new()
        {
        ...
        public static List<MovieSession> MovieSessions = new();
        ...
        static Database()
        {
            ...
            MovieSessions.AddRange(new[]
            {
                ...
                new MovieSession(Guid.NewGuid(), hall2, "Avatar", Genre.Action, 2026, DateTime.Today.AddHours(10), 160),
                new MovieSession(Guid.NewGuid(), hall2, "Zoopolis", Genre.Cartoon, 1997, DateTime.Today.AddHours(14), 195),
                new MovieSession(Guid.NewGuid(), hall2, "Shrek", Genre.Cartoon, 2001, DateTime.Today.AddHours(18), 90),
                new MovieSession(Guid.NewGuid(), hall2, "Goat", Genre.Cartoon, 2019, DateTime.Today.AddHours(21), 120),
